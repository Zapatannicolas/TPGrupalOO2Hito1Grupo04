...
public class TestPersona {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//Persona cocinero = new Cocinero("Panchos", 1000 ,38742121, "Francisco", "Jordans", LocalDate.of(1999, 3, 11), LocalDate.of(2020, 5, 20), 1500000f, LocalDate.of(2026, 8, 23), abmFestival.traer(1));
		//	abmPersona.agregar(cajero);
		//	abmPersona.agregar(cocinero);
		} catch (Exception e) {
